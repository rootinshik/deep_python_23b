...
class TestCustomList(unittest.TestCase):
    ...
    def test_addition(self):
        ...
        self.assertEqual(result1, CustomList([6, 3, 10, 7]))
    ...
    def test_addition_with_different_lengths(self):
        ...
        self.assertEqual(result1, CustomList([6, 1, 3, 7]))
        self.assertEqual(result2, CustomList([6, 1, 3, 7]))
    ...
    def test_subtraction(self):
        ...
        self.assertEqual(result1, CustomList([0, 0, 0, -1]))
        self.assertEqual(result2, CustomList([0, 0, 0, 1]))
    ...
    def test_subtraction_with_different_lengths(self):
        ...
        self.assertEqual(result1, CustomList([4, 1, 3, 7]))
        self.assertEqual(result2, CustomList([-4, -1, -3, -7]))
    ...
    def test_subtraction_with_list(self):
        ...
        self.assertEqual(result1, CustomList([4, -1, -4, 7]))
